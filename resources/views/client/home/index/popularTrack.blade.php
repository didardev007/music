...
{{--@push('scripts')
    <script>
        ...
        audio.addEventListener('ended', function () {
            ...
            document.getElementsById('albumImage' + currentTrackId).classList.remove('spinning');
            document.getElementsById('playPauseButton' + currentTrackId).classList.remove('bi-pause-btn');
            document.getElementsById('playPauseButton' + currentTrackId).classList.add('bi-play-btn');
