                ...
                <div class="col-2">
                    <div class="d-md-flex">
                        <div class="text-end me-md-2">
                            <!-- Play button using HTML audio tag -->
                            <button class="btn btn-md btn-outline-danger bi bi-play-btn" onclick="playAudio('{{asset('track/selim.mp3') }}')">
                        ...
                        <div class="text-end ms-md-2">
                            <form id="favoriteForm{{ $track->id }}" method="post"
                                  action="{{ route('markFavorite', ['trackId' => $track->id]) }}">
                                @csrf
                                <button
